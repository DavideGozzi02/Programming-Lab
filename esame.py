        ...
        for line in openedfile:
            ...
            if (datas[0] != 'epoch'): 
                ...
                if (int(datas[0]) <= previous_epoch): 
                    raise ExamException("non ordine")
    ...
    for item in time_series:
        ...
        if (current_day != previous_day):
            ...
            for liste in time_series:
                #controllo se l'elemnto che sto considerendo nel sceondo for ha la stessa data del item
...
#ora stampo la differenza massima di temperatura giorno per giorno
for item in es:
    print(round(item, 3))